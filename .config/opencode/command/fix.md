...
**Why this is possible (but less likely)**:
  ...
  DTO validation doesn't check subscription existence
...
```
 ...
 Cross-Project Memory:
  Similar bug: react-state-stale-closure-2025-09
...
```
 ...
 Cross-Project Memory:
  Similar: stripe-webhook-replay-attack-2025-10
  Similar: race-condition-async-payment-2025-07
 ...
 Phase 2: Reproduction (20 min)
  Intermittent: 3 successes, 2 failures in 5 attempts
