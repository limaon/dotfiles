...
- Use only standard ASCII characters (a-z, A-Z, 0-9, basic punctuation: . , ; : ! ? - ( ) [ ] " ' / \ @ # $ % & * + = < > ^ _ ` { } | ~). Never use em-dash (---), en-dash (--), curly quotes, smart apostrophes, ellipsis (...), arrows, or other special unicode characters (tool to support iconv).
